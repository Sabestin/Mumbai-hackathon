...
<body>
  ...
  <section>
    <div class="container">
      <form name='book' method="post" action="signup.php"  onsubmit="return validation()">
<br><br><br><br><br>
     	<center>
     	<h2> REGISTER HERE </h2>
       <br><br>
       <div class="floating-form">
          ...
          <div class="floating-form">
                <div class="floating-label">
                  <input class="floating-input" type="text" name="contact"placeholder=" " required pattern="[7-9]{1}[0-9]{9}" title="Phone number with 7-9 and remaining digits with 0-9" maxlength="10">
                  <span class="highlight"></span>
                  <label>contact </label>
                </div>

     	<div class="floating-label">
           <input class="floating-input" type="pass" name="password" placeholder=" " required>
           <span class="highlight"></span>
